...
class RtfFormatter(Formatter):
    ...
    def __init__(self, **options):
        ...
        self.lineno_fontsize = get_int_opt(options, "lineno_fontsize", self.fontsize)
    ...
    def _lineno_template(self):
        ...
        return "{{\\cf{} %s{}}}".format(
            self.color_mapping[self.lineno_color], " " * self.lineno_padding
        )
    ...
    def format_unencoded(self, tokensource, outfile):
        ...
        for ttype, value in tokensource:
            ...
            if style["underline"]:
                buf.append("\\ul")
            if style["border"]:
                buf.append("\\chbrdr\\chcfpat%d" % self.color_mapping[style["border"]])
            start = "".join(buf)
            if start:
