...
from pip._vendor.pygments.token import STANDARD_TYPES, Text, Token
    ...
    **Subclassing the HTML formatter**
    ...
    def get_background_style_defs(self, arg=None):
        ...
        if arg and not self.nobackground and bg_color is not None:
            ...
            lines.insert(
                0, "{}{{ background: {};{} }}".format(prefix(""), bg_color, text_style)
            )
    ...
    def _format_lines(self, tokensource):
        ...
        for ttype, value in tokensource:
            try:
                ...
                title = (
                    ' title="{}"'.format(".".join(ttype))
                    if self.debug_token_types
                    else ""
                )
                if nocls:
            ...
            if i + 1 in hls:  # i + 1 because Python indexes start at 0
                if self.noclasses:
                    ...
                    if self.style.highlight_color is not None:
                        style = (
                            f' style="background-color: {self.style.highlight_color}"'
                        )
